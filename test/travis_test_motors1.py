...
class MotorTest(unittest.TestCase):
	...
	def test_pub_freq(self):
		...
		self.file_check("rtmotor_raw_r0",m.right_hz,"wrongright value from motor_raw")
	...
	def test_pub_cmd_vel(self):
		...
		self.file_check("rtmotor_raw_r0",0,"dont't stop after 1[s]")
		self.file_check("rtmotor_raw_l0",0,"dont't stop after 1[s]")
